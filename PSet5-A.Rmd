...
To
    ...
    Yujing will investigate on the topic of mean of salary vs. salary range, and she also wants to draw plots to show the job types and job categories of these variables.
...
List three questions that you hope you will be able to answer from your research.
  ...
  Main topic: What factors maybe influence salary?
    ...
    d) The relationship between salary vs. salary range.

### 6.2. Short Summary of Initial Investigations
