...
2. Data exploration
  ...
  + Data description
  + Short Summary of Initial Investigations

3. Analyzing part
  
  + Region distribution of salaries
(Our work is here, please fill it out when you are doing your part.  Thank you:) )
...
job %>%
  ...
  ggplot(aes(x = reorder(Category,salary,FUN=mean), y = salary)) +
