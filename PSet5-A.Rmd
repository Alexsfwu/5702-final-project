...
htmlTable(head(mini_freq, 20), caption="Minimum Qual Requirements in All Jobs Word Frequency", 
          er=c("Word", "Frequency"), rnames=FALSE)
```
<!-- ```{r} -->
<!-- library(wordcloud2) -->
<!-- library(webshot) -->
...
htmlTable(head(pref_freq, 20), caption="Preferred Skills in All Jobs Word Frequency", 
          er=c("Word", "Frequency"), rnames=FALSE)
```
```{r}
library(wordcloud2)
...
# 
htmlTable(head(tech_mini_freq, 20), caption="Minimum Qual Requirements in Technology Related Jobs Word Frequency", 
          er=c("Word", "Frequency"), rnames=FALSE)
```
```{r}
library(wordcloud2)
