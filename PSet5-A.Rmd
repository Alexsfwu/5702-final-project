...
To
    ...
    Shaofeng will work on the data cleaning and mabipulation, and he try to find connections among NAs or may come up with interesting topics when doing the data cleaning. 
...
Our data come from https://data.cityofnewyork.us/City-Government/NYC-Jobs/kpav-sd4t, which contains current job postings available on the City of New York’s official jobs site http://www.nyc.gov/html/careers/html/search/search.shtml. The data can be directly exported from the website so there's no obstacle for us to gather the data.
